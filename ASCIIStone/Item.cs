...
public class ItemProperty
{
    public static Dictionary<ItemTypes, ItemProperty> itemProperties = new Dictionary<ItemTypes, ItemProperty>
    {
        ...
        {ItemTypes.wood_sword, new ItemProperty(itemType: ItemTypes.wood_sword, itemName: "Wooden Sword", itemTier: ItemTiers.wood, toolType: ToolTypes.sword, normalChar: 's', normalHealth: 64, entityDamage: 4f, woodDamage: 2f, itemUsage: ItemUsage.malee_weapon)},
        {ItemTypes.wood_pickaxe, new ItemProperty(itemType: ItemTypes.wood_pickaxe, itemName: "Wooden Pickaxe", itemTier: ItemTiers.wood, toolType: ToolTypes.pickaxe, 'p', normalHealth: 64, entityDamage: MIN_ENTITY_DAMAGE * 2f, stoneDamage: 1f, itemUsage: ItemUsage.tool)},
        {ItemTypes.wood_axe, new ItemProperty(itemType: ItemTypes.wood_axe, itemName: "Wooden Axe", itemTier: ItemTiers.wood, toolType: ToolTypes.axe, normalChar: 'a', normalHealth: 64, entityDamage: 2f, woodDamage: 2f, itemUsage: ItemUsage.tool)},
        {ItemTypes.stone_sword, new ItemProperty(itemType: ItemTypes.stone_sword, itemName: "Stone Sword", itemTier: ItemTiers.stone, toolType: ToolTypes.sword, normalChar: 's', normalHealth: 128, entityDamage: 6f, woodDamage: 2f, itemUsage: ItemUsage.malee_weapon)},
        {ItemTypes.stone_pickaxe, new ItemProperty(itemType: ItemTypes.stone_pickaxe, itemName: "Stone Pickaxe", itemTier: ItemTiers.stone, toolType: ToolTypes.pickaxe, normalChar: 'p', normalHealth: 128, entityDamage: MIN_ENTITY_DAMAGE * 2.5f, woodDamage: MIN_WOOD_DAMAGE * 1.5f, stoneDamage: 2f, itemUsage: ItemUsage.tool)},
        {ItemTypes.stone_axe, new ItemProperty(itemType: ItemTypes.stone_axe, itemName: "Stone Axe", itemTier: ItemTiers.stone, toolType: ToolTypes.axe, normalChar: 'a', normalHealth: 128, entityDamage: 3f, woodDamage: 4f, itemUsage: ItemUsage.tool)},
